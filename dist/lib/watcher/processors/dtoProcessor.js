 ...
 */
function parseYupText(text, context = "", schemaRefs = {}) {
    text = text.trim();
 ...
 */
function extractBalancedContent(text, start) {
    let depth = 1;
    let i = start;
    let content = "";
    let inString = false;
 ...
 */
function extractYupSchemas(source) {
    const results = {};
 ...
 */
function stripExportDeclaration(schemaText) {
 ...
 * Process DTO file
 */
export function processDtoFile(filePath) {
