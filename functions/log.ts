 ...
 */
function format(msg: unknown): string {
  if (msg instanceof Error) return chalk.red(msg.message);
  if (typeof msg === "object") return chalk.white(JSON.stringify(msg, null, 2));
